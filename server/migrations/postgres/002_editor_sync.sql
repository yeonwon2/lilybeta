...
-- Integration metadata is backend-only; Supabase anon/authenticated roles get no policy.
ALTER TABLE editor_book_links ENABLE ROW LEVEL SECURITY;
ALTER TABLE editor_chapter_links ENABLE ROW LEVEL SECURITY;
